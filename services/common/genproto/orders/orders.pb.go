...
type CreateOrderRequest struct {
	...
	QuantityID    int32                  `protobuf:"varint,3,opt,name=quantityID,proto3" json:"quantityID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateOrderRequest) GetQuantityID() int32 {
	if x != nil {
		return x.QuantityID
	}
	return 0
...
const file_orders_proto_rawDesc = "" +
	...
	"customerID\x12\x1c\n" +
	"\tProductID\x18\x02 \x01(\x05R\tProductID\x12\x1e\n" +
	"\n" +
	"quantityID\x18\x03 \x01(\x05R\n" +
	"quantityID\"-\n" +
	...
	"\x06orders\x18\x01 \x03(\v2\x06.OrderR\x06orders2K\n" +
	"\rOrdersService\x12:\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00B,Z*https://github.com/sikozonpc/common/ordersb\x06proto3"
